...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.analy_box = QtWidgets.QComboBox(self.formLayoutWidget)
        self.analy_box.setObjectName("analy_box")
        self.analy_box.addItem("")
        self.analy_box.addItem("")
        self.analy_box.addItem("")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.analy_box)
        ...
        self.graphics_view.setGeometry(QtCore.QRect(510, 50, 481, 501))
        ...
        self.source_list = QtWidgets.QListView(self.centralwidget)
        self.source_list.setGeometry(QtCore.QRect(10, 50, 231, 301))
        self.source_list.setObjectName("source_list")
        self.stop_list = QtWidgets.QListView(self.centralwidget)
        self.stop_list.setGeometry(QtCore.QRect(10, 411, 231, 161))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.analy_box.setItemText(0, _translate("MainWindow", "default"))
        self.analy_box.setItemText(1, _translate("MainWindow", "jieba"))
        self.analy_box.setItemText(2, _translate("MainWindow", "english"))
